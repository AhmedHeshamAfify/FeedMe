...
export class PaymentCardComponent implements OnInit {
  ...
  constructor(private service: PaymentService,private authService: AuthService,private fb: FormBuilder,
  ...
  ngOnInit() {
    this.createForm();
    this.utilsService.clearFromCache('meal')
  }
  ...
  Pay() {
    ...
    const index=this.user.orders.length -1
    this.newOrderPayment =this.user.orders[index]


    let orders = {
      orderNum: this.newOrderPayment.orderNum ,
      address: {
